...
export interface InitOutput {
  ...
  readonly spSkeleton_updateWorldTransform: (a: number) => void;
  ...
  readonly spine_strlen: (a: number) => number;
  readonly spine_strcmp: (a: number, b: number) => number;
  readonly spine_strncmp: (a: number, b: number, c: number) => number;
  readonly spine_strcasecmp: (a: number, b: number) => number;
  readonly spine_strcpy: (a: number, b: number) => number;
  readonly spine_strncat: (a: number, b: number, c: number) => number;
  readonly spine_strtol: (a: number, b: number, c: number) => number;
  readonly spine_strtoul: (a: number, b: number, c: number) => number;
  readonly spine_strrchr: (a: number, b: number) => number;
  readonly spine_rand: () => number;
  readonly spine_sqrtf: (a: number) => number;
  readonly spine_malloc: (a: number) => number;
  readonly spine_realloc: (a: number, b: number) => number;
  readonly spine_free: (a: number) => void;
  readonly spine_memcpy: (a: number, b: number, c: number) => number;
  readonly spine_memmove: (a: number, b: number, c: number) => number;
  readonly spine_memset: (a: number, b: number, c: number) => number;
  readonly spine_fopen: (a: number, b: number) => number;
  readonly spine_fclose: (a: number) => number;
  readonly spine_fread: (a: number, b: number, c: number, d: number) => number;
  readonly spine_fseek: (a: number, b: number, c: number) => number;
  readonly spine_ftell: (a: number) => number;
  ...
  readonly spPropertyIdArray_add: (a: number, b: number) => void;
  ...
  readonly spPropertyIdArray_contains: (a: number, b: number) => number;
  readonly spPropertyIdArray_pop: (a: number) => number;
  readonly spPropertyIdArray_peek: (a: number) => number;
  ...
  readonly _spAnimationState_addPropertyID: (a: number, b: number) => number;
  ...
  readonly spSkeleton_updateWorldTransformWith: (a: number, b: number) => void;
  ...
  readonly _spMalloc: (a: number, b: number, c: number) => number;
  ...
  readonly _spCalloc: (a: number, b: number, c: number, d: number) => number;
  readonly _spRealloc: (a: number, b: number) => number;
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0b4babd64eba9ac0: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h697af02a6c372d84: (a: number, b: number) => void;
